...
describe('nativeImage module', () => {
  ...
  describe('addRepresentation()', () => {
    it('supports adding a buffer representation for a scale factor', () => {
      ...
      assert.equal(image.toDataURL({scaleFactor: 2.0}), 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAIAAAD91JpzAAAAFklEQVQYlWP8//8/AwMDEwMDAwMDAwAkBgMBBMzldwAAAABJRU5ErkJggg==')
